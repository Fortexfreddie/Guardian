                                ...
                                <tbody>
                                    {
                                        BlockData.map((block, index) => (
                                            <tr key={index} className="border-b border-gray-300 transition-colors hover:bg-gray-50">
                                                <td className="p-4 align-middle"><span className="cursor-pointer">{block.height}</span></td>
                                                <td className="p-4 align-middle"><span className="flex gap-2 items-center">{block.hash} <span className="cursor-pointer hover:scale-110"><Copy className="h-3 w-3" /></span></span></td>
